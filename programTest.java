...
public class programTest {
    public static void main (String[] args)
    {
       ...
       // Automobile van = new Automobile(2016, "Ford", "Mazda", "Yellow", "Beast", 4, diceRoll);
        ...
        Truck truck = new Truck(2017, "Ford", "Focus", "Black", "trucky", 3, diceRoll);
        Van van = new Van(2016, "Ford", "Mazda", "Yellow", "Beast", 4, diceRoll);
        Sports sports = new Sports(2017, "Hyundai", "nemesis", "Blue", "Penelope", 6, diceRoll);
